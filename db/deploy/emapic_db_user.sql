...
GRANT SELECT, REFERENCES ON ALL TABLES IN SCHEMA base_layers TO :"emapic_db_user";

GRANT ALL ON SCHEMA opinions TO :"emapic_db_user";

GRANT USAGE ON SCHEMA public TO :"emapic_db_user";

GRANT SELECT, INSERT, UPDATE, DELETE, REFERENCES ON ALL TABLES IN SCHEMA public TO :"emapic_db_user";

GRANT SELECT, USAGE ON ALL SEQUENCES IN SCHEMA public TO :"emapic_db_user";

GRANT USAGE ON SCHEMA metadata TO :"emapic_db_user";

GRANT SELECT, INSERT, UPDATE, DELETE, REFERENCES ON ALL TABLES IN SCHEMA metadata TO :"emapic_db_user";
