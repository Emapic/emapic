-- Deploy emapic:ignore_null_provinces to pg
...
BEGIN;
    ...
    BEGIN
        IF (TG_OP = 'INSERT') THEN
            SELECT gid INTO new_province FROM base_layers.provinces WHERE name IS NOT NULL ORDER BY st_distance(geom, new.geom) ASC LIMIT 1;
