			...
			if (val in emapic.allCountriesData) {
				...
				emapic.utils.getJsonAlertError(
	                ...
	                $.each(data.features, function(i, province) {
						provinces.push(province.properties);
                        provincesData[province.properties.adm_code] = {};
                        provincesData[province.properties.adm_code].properties = province.properties;
	                    provincesData[province.properties.adm_code].bbox = [[province.geometry.coordinates[0][0][1], province.geometry.coordinates[0][0][0]],
