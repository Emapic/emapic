...
(function(emapic) {
    ...
    emapic.utils.getIconImageHtml = function(imageUrl, backgroundColor) {
        ...
        if (imageUrl !== null && imageUrl !== '') {
            markerContent = '<ellipse ry="13.192183" rx="13.02163" cy="16.567797" cx="16.64089" style="opacity:1;fill:#ffffff;fill-opacity:1;fill-rule:nonzero;stroke:#000000;stroke-width:1.02665293;stroke-linejoin:miter;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1" /><foreignObject class="image-marker-icon" height="33" width="33" y="{y}" x="{x}"><span class="inline-helper"></span><img src="' + imageUrl + '"></img></i></foreignObject>';
        }
