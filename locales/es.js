{
	...
	"geoposwarning_title": "Aviso de geoposicionamiento",
	...
	"geoposwarning_options_auto_title": "Geoposicionamiento automático:",
	...
	"geoposwarning_options_manual_title": "Geoposicionamiento manual:",
	...
	"geoposmanual_body": "Durante la encuesta te pediremos tu posición, la cual deberás especificar manualmente en un mapa partiendo de una posición por defecto genérica.",
	"geoposmanualip_body": "Durante la encuesta te pediremos que confirmes tu posición en un mapa partiendo de una posición aproximada obtenida de tu IP.",
	"geoposmanualdefault_body": "Durante la encuesta te pediremos que confirmes tu posición, la cual deberás especificar manualmente en un mapa partiendo de la posición por defecto de tu perfil.",
	"geoposapierror_body": "Lamentablemente no hemos sido capaces de localizar tu posición exacta de manera automática, pero sí hemos podido obtener una posición aproximada a partir de tu IP.<br>Durante la encuesta te pediremos que confirmes tu posición partiendo de dicha aproximación.",
	"geoposallerror_body": "Lamentablemente no hemos sido capaces de localizar tu posición de manera automática.<br>Durante la encuesta te pediremos tu posición, la cual deberás especificar manualmente en un mapa partiendo de una posición por defecto genérica.",
	...
	"signup_disclaimer_header": "Confirmo que tengo al menos 14 años y que acepto las ",
	"signup_disclaimer_general_conditions": "Condiciones generales del registro de Emapic",
	...
	"js_see_my_position": "Ver mi posición",
	"js_see_my_country": "Ver mi país",
	...
	"update_api_success_msg": "Se ha actualizado correctamente API ID/Secret.",
	...
	"password_reset_confirm_mail_html_body": "<html>    <head></head>    <body>    <p>¡Hola %s!<br><br>Para resetear la contraseña de tu cuenta asociada a este correo pulsa en <a href=\"%s\">este enlace</a><br/>Si no has pedido resetear tu contraseña, simplemente ignora este e-mail.</p><p>Saludos<br>Equipo Emapic<br><a href=\"www.emapic.es\">www.emapic.es</a></p></body></html>",
	"password_reset_confirm_mail_text_body": "¡Hola %s!\n\nPara resetear la contraseña de tu cuenta asociada a este correo pulsa en este enlace: %s\n\nSi no has pedido resetear tu contraseña, simplemente ignora este e-mail.\n\nSaludos\nEquipo Emapic\nwww.emapic.es",
	...
	"question_type_text_answer_description": "El usuario simplemente escribirá un texto respondiendo a una pregunta.",
	"question_type_text_answer_legend": "No.",
	"question_type_explanatory_text_title": "Texto explicativo",
	"question_type_explanatory_text_description": "No se trata realmente de una pregunta, sino de un simple texto que se puede emplear, por ejemplo, para poner una introducción a la encuesta. Ten en cuenta que la encuesta debe tener al menos una pregunta de verdad.",
	...
	"image": "Imagen",
	"maximum_answer_image_size": "Máximo 1MB.",
	"survey_answer_image_file_too_big_msg": "Al menos una de las imágenes subidas es demasiado grande.",
	...
	"help_tooltip_new_survey_description": "Una descripción más detallada de la encuesta, que se mostrará en el listado de encuestas.",
	...
	"help_tooltip_new_survey_public_results": "La página de resultados será accesible para todo el mundo en todo momento, incluso si no ha votado en la encuesta.",
	...
	"account": "Cuenta",
	"api": "API",
	"api_id": "Identificador Aplicación",
	"api_secret": "Clave secreta",
	"regenerate_api": "Regenerar API ID/Secret",
	"welcome": "¡Bienvenido",
	"see_all": "Ver todas",
